...
<p align='center'><a id='figure-1a'>(a)</a> non fine-tuned T5-Large model, SQuAD Dataset
...
<p align='center'><a id='figure-1b'>(b)</a> fine-tuned T5-Large model, SQuAD Dataset</p>
...
<p align='center'><a id='figure-1c'>(c)</a> non fine-tuned T5-Large model, SamSum Dataset</p>
...
<p align='center'><a id='figure-1b'>(d)<a> fine-tuned T5-Large model, SamSum Dataset</p>
...
<p align='center'>
<img src="./blogpost_images/plots/Final Plot Squad F1.png" alt="F1 Metric for T5-Large and T5-Finetuned with No, Fixed, or Decaying reduction applied to the W_j matrix" style="width:48%; display:inline-block; margin: 0 2.5%;" />
</p>
<p align='center'><b>F1 Metric</b> for T5-Large and T5-Finetuned with <i>No</i>, <i>Fixed</i>, or <i>Decaying</i> reduction applied to the <b>W_j</b> matrix</p>

<p align='center'>
<img src="./blogpost_images/plots/Final Plot Squad Flops.png" alt="FLOPs per sample for T5-Large and T5-Finetuned with No, Fixed, or Decaying reduction applied to the W_j matrix" style="width:48%; display:inline-block; margin: 0 2.5%;" />
</p>
...
<p align='center'>Rouge-L for T5-Large and T5-Finetuned with <i>No</i>, <i>Fixed</i>, or <i>Decaying</i> reduction applied to the <b>W_j</b> matrix</p>

<p align='center'>
<img src="./blogpost_images/plots/Final Plot Samsum flops.png" alt="FLOPs per sample for T5-Large and T5-Finetuned with No, Fixed, or Decaying reduction applied to the W_j matrix" style="width:48%; display:inline-block; margin: 0 2.5%;" />
</p>
<p align='center'><b>FLOPs per sample</b> for T5-Large and T5-Finetuned with <i>No</i>, <i>Fixed</i>, or <i>Decaying</i> reduction applied to the <b>W_j</b> matrix</p>
