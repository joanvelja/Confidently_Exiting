...
Finally, all the experiments in the following sections are done using the available <a href="https://github.com/raymin0223/fast_robust_early_exit"> codebase fast-robust-early-exit</a> ([Bae et al., 2023](#fast-robust-early-exiting-2023)) as baseline.
